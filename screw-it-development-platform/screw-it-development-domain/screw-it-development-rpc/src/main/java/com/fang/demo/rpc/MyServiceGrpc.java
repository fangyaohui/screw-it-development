...
public final class MyServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.fang.demo.rpc.HelloRequest,
      com.fang.demo.rpc.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.fang.demo.rpc.HelloRequest.class,
      responseType = com.fang.demo.rpc.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.fang.demo.rpc.HelloRequest,
      com.fang.demo.rpc.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.fang.demo.rpc.HelloRequest, com.fang.demo.rpc.HelloReply> getSayHelloMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSayHelloMethod = MyServiceGrpc.getSayHelloMethod) == null) {
          MyServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.fang.demo.rpc.HelloRequest, com.fang.demo.rpc.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.fang.demo.rpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.fang.demo.rpc.HelloReply.getDefaultInstance()))
  ...
  public static abstract class MyServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.fang.demo.rpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.fang.demo.rpc.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.fang.demo.rpc.HelloRequest,
                com.fang.demo.rpc.HelloReply>(
  ...
  public static final class MyServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MyServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.fang.demo.rpc.HelloReply sayHello(com.fang.demo.rpc.HelloRequest request) {
  ...
  public static final class MyServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MyServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.fang.demo.rpc.HelloReply> sayHello(
        com.fang.demo.rpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.fang.demo.rpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.fang.demo.rpc.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.fang.demo.rpc.HelloWorldProto.getDescriptor();
    }
